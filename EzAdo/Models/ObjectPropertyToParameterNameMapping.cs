...
{
    /// <summary>
    /// A ObjectPropertyToParameterNameMapping is utilized in the LoadFromObject T calls when the
    /// procedure parameters are loaded from an object. The mapping aligns the Procedures
    /// ParamaterName to a property in a C# object where object.ParameterName =
    /// Procedure["@PARAMETER_NAME"].
    /// </summary>
